...
pipeline {
    ...
    environment {
        ...
        ALL_SERVICES          = 'cart,customer,inventory,location,media,order,product,rating,search,tax,recommendation,payment,payment-paypal,sampledata,webhook,promotion,backoffice-bff,storefront-bff'
